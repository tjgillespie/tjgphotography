...
class UpdateModeTest extends KernelTestBase {
  ...
  protected function setUp() {
    ...
    $this->installConfig(['system', 'user', 'field', 'filter', 'text', 'node', 'config_sync_test']);
    ...
    $content_type_3->delete($this->nodeTypeNames[3]);
  ...
  public function testUpdateModeMerge() {
    ...
    $this->container->get('event_dispatcher')->dispatch(ConfigDistroEvents::IMPORT);
